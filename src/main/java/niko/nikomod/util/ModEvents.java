        ...
        AttackEntityCallback.EVENT.register((player, world, hand, entity, hitResult) -> {
            if(entity instanceof LivingEntity livingEntity){
                if(player.getMainHandStack().isIn(ModTags.Items.STARSILVER_ITEMS) && entity.getType().isIn(EntityTypeTags.SENSITIVE_TO_SMITE)){
                    ...
                    livingEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.WEAKNESS, 300, 2, false, false));
                    livingEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS, 300,2, false, false ));
                }
